...
/******/ 	__webpack_require__.p = "/home/erik/Repositories/computer-tutor/client";
/******/
/******/
...
function (_React$Component) {
  ...
  function Console() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Console).apply(this, arguments));
  }
  ...
  _createClass(Console, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        id: "console-prompt"
      }, this.getMessage(), ":"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        id: "console-input"
      }, this.props.currentLine), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "console-output-container"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "console-container"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "console-label"
      }, "History"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "console-group"
      }, this.props.history.map(function (val, i) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          key: 'history' + val + i
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, val));
      }))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "console-container"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "console-label"
        ...
        className: "console-group"
      }, this.props.rovers.map(function (rover, i) {
        if (!rover.isDoneMoving) return '';
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          key: "rover-output-".concat(i)
    ...
    value: function getMessage() {
      switch (this.props.stateName) {
        case 'build':
          return '$ build plateau (x, y)';

        case 'deploy':
          return '$ deploy rover (x, y, N|S|E|W)';

        case 'move':
          return '$ move rover (L|R|M)';
...
/* harmony import */ var _rover_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./rover.js */ "./src/rover.js");




react_dom__WEBPACK_IMPORTED_MODULE_0___default.a.render(react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_rover_js__WEBPACK_IMPORTED_MODULE_3__["default"], null), document.getElementById('root'));
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(Plateau, _React$Component);
  ...
  function Plateau() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Plateau)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "getRow", function (val, x) {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "plateau-row",
        key: 'row' + x
      }, Array(_this.props.dimensions.height).fill(x).map(_this.getCol).reverse());
    });

    _defineProperty(_assertThisInitialized(_this), "getCol", function (x, y) {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "location",
        key: x + ',' + y
      }, _this.getRoverAtLocation(x, y));
    });

    _defineProperty(_assertThisInitialized(_this), "getRoverAtLocation", function (x, y) {
      var ret = [];

      for (var i in _this.props.rovers) {
        var rover = _this.props.rovers[i];
        var cssClass = rover.isDoneMoving ? 'rover-dead' : 'rover-alive';
        if (rover.x !== x || rover.y !== y) continue;
        ret.push(_this.getArrow(rover.direction.toUpperCase(), i, cssClass));
      }

      return ret;
    });

    _defineProperty(_assertThisInitialized(_this), "getArrow", function (direction, roverIndex, cssClass) {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_fontawesome__WEBPACK_IMPORTED_MODULE_1___default.a, {
        name: Plateau.arrowDirections[direction],
        key: 'rover' + roverIndex,
        className: cssClass
      });
    });
  ...
  _createClass(Plateau, [{
    key: "render",
    value: function render() {
      if (!this.props.dimensions.width || !this.props.dimensions.height) return null;
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "plateau"
      }, Array(this.props.dimensions.width).fill(1).map(this.getRow));
    } // to be used in map function (see render), val is always 1
...
_defineProperty(Plateau, "arrowDirections", {
  N: 'arrow-up',
  S: 'arrow-down',
  E: 'arrow-right',
  W: 'arrow-left'
...
/* harmony default export */ __webpack_exports__["default"] = (Plateau);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _plateau_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./plateau.js */ "./src/plateau.js");
/* harmony import */ var _console_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./console.js */ "./src/console.js");
/* harmony import */ var _stateManipulator_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./stateManipulator.js */ "./src/stateManipulator.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(Rover, _React$Component);
  ...
  function Rover(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Rover).call(this, props));

    _defineProperty(_assertThisInitialized(_this), "handleKeydown", function (e) {
      _this.setState(function (state) {
        var _char = String.fromCharCode(e.which);

        var nextState = _stateManipulator_js__WEBPACK_IMPORTED_MODULE_3__["default"].getNextState(state.data, _char);
        if (!nextState) return;
        return {
          data: nextState
        };
    ...
    _this.state = {
      data: {
        rovers: [],
        // rovers deployed (object, keys: x, y, dir, isDone)
        inputHistory: [],
        // user input history (strings)
        stateHistory: [],
        // history of states (object)
        dimensions: {
          // tracks dimensions of plateau (first input)
          width: 0,
          height: 0
        },
        input: '',
        // current line of user input
        stateName: _stateManipulator_js__WEBPACK_IMPORTED_MODULE_3__["default"].stateNames[0],
        // current state name
        statePhase: 0 // current state phase (index)
  ...
  _createClass(Rover, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "rover"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_plateau_js__WEBPACK_IMPORTED_MODULE_1__["default"], {
        dimensions: this.state.data.dimensions,
        rovers: this.state.data.rovers
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_console_js__WEBPACK_IMPORTED_MODULE_2__["default"], {
        history: this.state.data.inputHistory,
        currentLine: this.state.data.input,
        rovers: this.state.data.rovers,
...
var StateManipulator = function StateManipulator() {
  _classCallCheck(this, StateManipulator);
};

_defineProperty(StateManipulator, "stateNames", [// identifiers for state
'build', 'deploy', 'move']);

_defineProperty(StateManipulator, "getNextState", function (state, _char) {
  // always check global state transitions first
  var applicableTransitions = StateManipulator.stateTransitions.global;
  applicableTransitions = applicableTransitions.concat(StateManipulator.stateTransitions[state.stateName][state.statePhase]);

  for (var i in applicableTransitions) {
    var res = applicableTransitions[i](state, _char);
    if (!res) continue;
...
_defineProperty(StateManipulator, "stateTransitions", {
  'global': [function (state, _char2) {
    // char is backspace and input !== '' --> prev state
    if (_char2 !== '\b' || state.input.length === 0) return null;
    return state.stateHistory.slice().pop();
  }],
  'build': [[// state: build0
  function (state, _char3) {
    // /\d/ --> build1
    if (!/\d/.test(_char3)) return null;
    return StateManipulator.finalizeStateChanges({
      stateName: StateManipulator.stateNames[0],
      statePhase: 1
    }, state, _char3);
  }], [// state: build1
  function (state, _char4) {
    // /\d/ --> build1
    if (!/\d/.test(_char4)) return null;
    return StateManipulator.finalizeStateChanges({
      stateName: StateManipulator.stateNames[0],
      statePhase: 1
    }, state, _char4);
  }, function (state, _char5) {
    // / / --> build2
    if (!/ /.test(_char5)) return null;
    return StateManipulator.finalizeStateChanges({
      stateName: StateManipulator.stateNames[0],
      statePhase: 2
    }, state, _char5);
  }], [// state: build2
  function (state, _char6) {
    // /\d/ --> build3
    if (!/\d/.test(_char6)) return null;
    return StateManipulator.finalizeStateChanges({
      stateName: StateManipulator.stateNames[0],
      statePhase: 3
    }, state, _char6);
  }], [// state: build3
  function (state, _char7) {
    // /\d/ --> build3
    if (!/\d/.test(_char7)) return null;
    return StateManipulator.finalizeStateChanges({
      stateName: StateManipulator.stateNames[0],
      statePhase: 3
    }, state, _char7);
  }, function (state, _char8) {
    // /[\r|\n]/ --> deploy0
    if (!/[\r|\n]/.test(_char8)) return null;

    var _state$input$split$ma = state.input.split(' ').map(function (v, i) {
      return parseInt(v, 10);
    }),
        _state$input$split$ma2 = _slicedToArray(_state$input$split$ma, 2),
        w = _state$input$split$ma2[0],
        h = _state$input$split$ma2[1];

    return StateManipulator.finalizeStateChanges({
      stateName: StateManipulator.stateNames[1],
      statePhase: 0,
      dimensions: {
        width: w + 1,
        height: h + 1
  ...
  'deploy': [[// state: deploy0
  function (state, _char9) {
    // /\d/ --> deploy1
    if (!/\d/.test(_char9)) return null;
    return StateManipulator.finalizeStateChanges({
      stateName: StateManipulator.stateNames[1],
      statePhase: 1
    }, state, _char9);
  }], [// state: deploy1
  function (state, _char10) {
    // /\d/ --> deploy1
    if (!/\d/.test(_char10)) return null;
    return StateManipulator.finalizeStateChanges({
      stateName: StateManipulator.stateNames[1],
      statePhase: 1
    }, state, _char10);
  }, function (state, _char11) {
    // /[\r|\n]/ --> deploy2
    if (!/ /.test(_char11)) return null;
    return StateManipulator.finalizeStateChanges({
      stateName: StateManipulator.stateNames[1],
      statePhase: 2
    }, state, _char11);
  }], [// state: deploy2
  function (state, _char12) {
    // /\d/ --> deploy3
    if (!/\d/.test(_char12)) return null;
    return StateManipulator.finalizeStateChanges({
      stateName: StateManipulator.stateNames[1],
      statePhase: 3
    }, state, _char12);
  }], [// state: deploy3
  function (state, _char13) {
    // /\d/ --> deploy3
    if (!/\d/.test(_char13)) return null;
    return StateManipulator.finalizeStateChanges({
      stateName: StateManipulator.stateNames[1],
      statePhase: 3
    }, state, _char13);
  }, function (state, _char14) {
    // / / --> deploy4
    if (!/ /.test(_char14)) return null;
    return StateManipulator.finalizeStateChanges({
      stateName: StateManipulator.stateNames[1],
      statePhase: 4
    }, state, _char14);
  }], [// state: deploy4
  function (state, _char15) {
    // /[n|s|e|w]/i --> deploy5
    if (!/[n|s|e|w]/i.test(_char15)) return null;
    return StateManipulator.finalizeStateChanges({
      stateName: StateManipulator.stateNames[1],
      statePhase: 5
    }, state, _char15);
  }], [// state: deploy5
  function (state, _char16) {
    // /[\r|\n]/ --> move0
    if (!/[\r|\n]/.test(_char16)) return null;

    var _state$input$split$ma3 = state.input.split(' ').map(function (v, i) {
      if (i === 2) return v;
      return parseInt(v, 10);
    }),
        _state$input$split$ma4 = _slicedToArray(_state$input$split$ma3, 3),
        x = _state$input$split$ma4[0],
        y = _state$input$split$ma4[1],
        dir = _state$input$split$ma4[2]; // DO NOT finalize state changes
    // if the user enters invalid dimensions and hits enter
    // this state should essentially start over at phase 0


    if (x >= state.dimensions.width || y >= state.dimensions.height) {
      var newInputHistory = state.inputHistory.slice();
      newInputHistory.push(state.input);
      return {
    ...
    var newRovers = state.rovers.slice();
    newRovers.push({
      x: x,
      y: y,
      direction: dir,
    ...
    return StateManipulator.finalizeStateChanges({
      stateName: StateManipulator.stateNames[2],
      statePhase: 0,
      rovers: newRovers
    }, state, _char16, true);
  }]],
  'move': [[// state move0
  function (state, _char17) {
    // /[l|r|m]/i --> move0
    if (!/[l|r|m]/i.test(_char17)) return null;
    var allRovers = state.rovers.slice();
    var thisRoverIndex = state.rovers.length - 1; // set new rover variables (make sure not to null out previous)

    var x = allRovers[thisRoverIndex].x;
    var y = allRovers[thisRoverIndex].y;
    var newDirection = allRovers[thisRoverIndex].direction;

    if (/m/i.test(_char17)) {
      var _StateManipulator$get = StateManipulator.getNextLocation(state, allRovers[thisRoverIndex]);

      var _StateManipulator$get2 = _slicedToArray(_StateManipulator$get, 2);

      x = _StateManipulator$get2[0];
      y = _StateManipulator$get2[1];
    } else {
      newDirection = StateManipulator.getNextDirection(allRovers[thisRoverIndex], /l/i.test(_char17));
    }

    allRovers[thisRoverIndex] = {
      x: x,
      y: y,
  ...
  }, function (state, _char18) {
    // /[\r|\n]/ --> deploy0
    if (!/[\r|\n]/.test(_char18)) return null;
    var allRovers = state.rovers.slice();
    allRovers[state.rovers.length - 1].isDoneMoving = true;
    return StateManipulator.finalizeStateChanges({
      stateName: StateManipulator.stateNames[1],
      statePhase: 0,
      rovers: allRovers
  ...
  // functionality done at the end of ALMOST every state transition
  //
  // INPUT
  // state: current data associated with state
  // char: the last character (keyboard input) pressed
  // goToNextState: true if transition caused stateName to change
  //
  // RETURN
  // new state object, updated as needed
  //

});

_defineProperty(StateManipulator, "finalizeStateChanges", function (newState, oldState, _char19) {
  var goToNextState = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  var newStateHistory = oldState.stateHistory.slice();
  newStateHistory.push(oldState); // update state history
  // reset input
  // update input history

  if (goToNextState) {
    var newInputHistory = oldState.inputHistory.slice();
    newInputHistory.push(oldState.input);
  ...
  // update input
  else return Object.assign({}, newState, {
      input: oldState.input + _char19,
      stateHistory: newStateHistory
    });
});

_defineProperty(StateManipulator, "getNextLocation", function (state, rover) {
  var xMod = 0;
  var yMod = 0;
  ...
  var ret = [rover.x + xMod, rover.y + yMod];
  if (ret[0] < 0 || ret[0] > state.dimensions.width - 1 || ret[1] < 0 || ret[1] > state.dimensions.height - 1) return [rover.x, rover.y];
  return ret;
});

_defineProperty(StateManipulator, "getNextDirection", function (rover, turnLeft) {
  var directions = ['N', 'W', 'S', 'E'];
  if (!turnLeft) directions.reverse();
  var nextDirIndex = directions.indexOf(rover.direction) + 1;
  nextDirIndex = nextDirIndex % directions.length;
  return directions[nextDirIndex];
});

/* harmony default export */ __webpack_exports__["default"] = (StateManipulator);

/***/ })

/******/ });
//# sourceMappingURL=computer-tutor.client.react.dev.bundle.js.map